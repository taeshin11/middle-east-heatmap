...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about Middle East Heatmap — our mission, methodology, and commitment to transparent conflict intelligence.',
  keywords: 'Middle East conflict, MENA security, regional tensions, Middle East risk, conflict heatmap, Arab world, about us, conflict intelligence platform',
}
  ...
  return (
    <main className="bg-slate-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-bold text-slate-900 mb-4">About Middle East Heatmap</h1>
        <p className="text-xl text-slate-600 mb-10 leading-relaxed">Visual heatmap of conflict intensity and security risk levels across the Middle East and North Africa region</p>
        <div className="space-y-8">
          <section className="bg-white rounded-2xl border border-slate-100 p-6">
            <h2 className="text-2xl font-semibold text-slate-800 mb-4">Our Mission</h2>
            <p className="text-slate-600 leading-relaxed mb-4">Middle East Heatmap was built on the conviction that access to timely, accurate conflict intelligence should not be limited to governments, think tanks, or expensive subscription services. We believe that journalists, researchers, policy analysts, students, and engaged citizens deserve access to quality information to understand the world&apos;s most pressing security challenges.</p>
          ...
          <section className="bg-white rounded-2xl border border-slate-100 p-6">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">Middle East Heatmap provides a visual heatmap of conflict intensity and security risk levels across the Middle East and North Africa region. Our platform aggregates, verifies, and presents this data in a format designed for clarity and usability, so users can quickly understand the situation and track changes over time.</p>
            <p className="text-slate-600 leading-relaxed">We cover active conflicts and related indicators across multiple regions, providing visualizations, timelines, and analysis that contextualizes data within broader geopolitical realities.</p>
          </section>
          <section className="bg-white rounded-2xl border border-slate-100 p-6">
            <h2 className="text-2xl font-semibold text-slate-800 mb-4">Our Data Sources &amp; Methodology</h2>
            <p className="text-slate-600 leading-relaxed mb-4">Our data is compiled from publicly available sources including: official government reports, United Nations agencies (OCHA, UNHCR, WFP), academic conflict databases (ACLED, SIPRI, Uppsala Conflict Data Program), verified open-source intelligence, and internationally recognized news organizations.</p>
            <p className="text-slate-600 leading-relaxed">We prioritize source transparency and cross-reference multiple sources before publishing. Where sources disagree, we present the range of estimates rather than a single contested figure.</p>
          </section>
          <section className="bg-white rounded-2xl border border-slate-100 p-6">
            <h2 className="text-2xl font-semibold text-slate-800 mb-4">Why This Matters</h2>
            <p className="text-slate-600 leading-relaxed">Conflict data is inherently sensitive and often contested. We strive to present information in a factual, non-partisan manner — to ensure accurate information supports informed discussion, humanitarian response, and evidence-based policy. The data we track represents real human lives, and that responsibility guides everything we do.</p>
          </section>
          <section className="bg-white rounded-2xl border border-slate-100 p-6">
          ...
          <section className="bg-white rounded-2xl border border-slate-100 p-6">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">Traditional news media covers conflicts reactively. Middle East Heatmap provides continuous, structured monitoring that persists beyond news cycles. Where newspapers provide narrative, we provide data. Where TV coverage provides emotion, we provide quantified context.</p>
          ...
          <section className="bg-white rounded-2xl border border-slate-100 p-6">
            ...
            <p className="text-slate-600">For inquiries, corrections, or partnership opportunities, reach out at <strong>contact@middle-east-heatmap.vercel.app</strong>.</p>
          </section>
        </div>
      </div>
    </main>
